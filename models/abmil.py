...
class DAttention(nn.Module):
    def __init__(self, input_dim=512, n_classes=2, dropout=0.25, act='relu', rrt=None):
        ...
        # self.feature2 = [nn.Linear(176*2, 512)]   # brca
        # self.feature2 = [nn.Linear(154*3, 256)]   # rcc
        # self.feature2 = [nn.Linear(88*2, 512)] # nsclc
        # self.feature2 = [nn.Linear(132, 64)] # camelyon16
        ...
        if act.lower() == 'gelu':
            ...
            self.feature += [nn.ReLU()]
            # self.feature2 += [nn.ReLU()]
            # self.feature2 += [nn.Linear(256, 256)]

        if dropout:
            self.feature += [nn.Dropout(0.25)]
            # self.feature2 += [nn.Dropout(0.25)]
        # if rrt is not None:
        #     self.feature += [rrt] 
        self.feature = nn.Sequential(*self.feature)
