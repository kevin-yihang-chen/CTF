...
# 	img2 = [item[1] for item in batch]
# 	censor = torch.LongTensor([item[2] for item in batch])
# 	survival_months = torch.LongTensor([item[3] for item in batch])
# 	label = torch.LongTensor([item[4] for item in batch])
# 	slide_id = [item[5] for item in batch]
# 	coords = [item[6] for item in batch]
# 	# return [img, img2, label, slide_id, coords]
# 	return [img, img2, censor, survival_months, label, slide_id, coords]
